...
class WarningManager {
    ...
    constructor(modal) {
        ...
        this.modal.onclick = () => {
            ...
            this.modal.style.transition = "all 0s";
        };
    }

    warningTaskAdded() {
        this.modalBody.style.backgroundColor = this.green;
        this.modalBody.textContent = "Task Added";
        this.modalToggle(4000);
    }

    warningTaskRemoved() {
        this.modalBody.style.backgroundColor = this.red;
        this.modalBody.textContent = "Task Removed";
        this.modalToggle(4000);
    }
    ...
    modalToggle(time) {
        ...
        this.modal.style.transition = "all 1s";
        setTimeout(() => {
            this.modal.style.visibility = "hidden";
            this.modal.style.opacity = "0";
        }, time);
